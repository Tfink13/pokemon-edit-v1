...
YoungsterData: ; COMPLETED
	db "Ben@",14,SNEASEL,RATTATA,$FF ; ROUTE3 #3
	...
	db "Josh@",26,EEVEE,EVEE,$FF ; Route 12 6u
...
CamperData:
	...
	db "Flint@",23,KOFFING,EKANS,$FF ; Route 24 1
...
BikerData: ; COMPLETED
	...
	db "Joel@",54,MUK,HOUNDOOM,$FF ; Route 15 5
	...
	db "Jimmy@",53,NINETALES,WEEZING,$FF ; Route 14 1l
...
BurglarData: ; COMPLETED
	...
	db "Darryl@",61,ARCANINE,FLAREON,$FF ; CINNABAR GYM 4
...
EngineerData: ; COMPLETED
	...
	db "Flint@",21,MAGNETON,ELECTRODE,$FF ; route 11 4u
...
SwimmerData: ; COMPLETED
	...
	db "Ben@",55,WARTORTLE,GYARADOS,STARMIE,$FF ; Route 21 1R
...
PkmnTrainerData:
	...
	db 54,GROWLITHE
	moveset FLAME_WHEEL, CRUNCH, FLAMETHROWER, ROAR

	db 55,GROWLITHE
	moveset FLAMETHROWER, CRUNCH, ROAR, DOUBLE_KICK

	db 57,ARCANINE
	moveset FLAMETHROWER, BODY_SLAM, BITE, ROAR
	db $FF
