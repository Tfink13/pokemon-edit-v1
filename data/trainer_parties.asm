...
YoungsterData:
	...
	db "Josh@",17,SNEASEL,NIDORAN_F,MAGNEMITE,$FF
...
LassData:
	...
	db "Jennifer@",10,FARFETCHD,NIDORAN_M,$FF
...
BikerData:
	...
	db "Jimmy@",28,GOLBAT,GRIMER,KOFFING,$FF
...
EngineerData:
	...
	db "Flint@",21,MAGNEMITE,ELECTRODE,$FF
...
SwimmerData:
	...
	db "Ben@",31,GYARADOS,DEWGONG,STARMIE,$FF
...
PkmnTrainerData:
	...
	db 33,IVYSAUR
	moveset LEECH_SEED, RAZOR_LEAF, SLEEP_POWDER, POISONPOWDER

	db 33,WARTORTLE
	moveset BUBBLEBEAM, BITE, WATER_GUN, WITHDRAW
